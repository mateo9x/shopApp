...
('ULTER', 'X-Pipe', '2400', 4, 9, '2021-10-24 14:54', 2, 'Stop aluminiowy', 'x-pipe.jpg'),
('ULTER', 'CatBack', '800', 4, 11, '2021-10-24 14:54', 2, 'Będzie głośno', 'catback.jpg');

update sqlversion set version = '2021_10_15';
